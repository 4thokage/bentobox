...
export default function GamePage({ initialLobby }: { initialLobby: Game }) {
  ...
  function updateTurnTitle() {
    ...
    if (!lobby.endReason && lobby.side === lobby.actualGame.turn()) {
      document.title = "(your turn) bentobox";
    } else {
      document.title = "bentobox";
    }
  }
  ...
  function copyInvite() {
    const text = `https://bentobox.ga/${lobby.endReason ? `archive/${lobby.id}` : initialLobby.code}`;
          ...
          <div className="flex flex-1 flex-col gap-1">
            <div className="mb-2 flex w-full flex-col items-end gap-1">
              ...
              >
                ...
                >
                  <IconCopy size={16} />
                  https://bentobox.ga/{lobby.endReason ? `archive/${lobby.id}` : initialLobby.code}
                </label>
              ...
              {lobby.endReason ? (
                <div>
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    https://bentobox.ga/archive/{lobby.id}
                  </a>
                  .
                </div>
              ) : abandonSeconds > 0 ? (
